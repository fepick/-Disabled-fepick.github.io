...
function init() {
    ...
    camera = new THREE.PerspectiveCamera( 70, widthHeightRatio.width/widthHeightRatio.height, 1, 1000 );
    ...
    effect.setSize( widthHeightRatio.width,widthHeightRatio.height );
    ...
    document.getElementById('wrap_three').appendChild( effect.domElement );
...
function onWindowResize() {
    ...
    camera.aspect = widthHeightRatio.width/widthHeightRatio.height;
